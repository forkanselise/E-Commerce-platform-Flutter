        ...
        child: Column(
          ...
          children: [
              ...
              child: Image.network(
                ...
                errorBuilder: (c, e, s) => Container(
                    ...
                    child: const Icon(Icons.phone_iphone,
                        size: 64, color: NexusTheme.accentCyan)),
              ),
            ),
            const SizedBox(height: 16),
            Row(
              children: [
                Container(
                  ...
                  child: Text(phone.brand.toUpperCase(),
                ...
                const Spacer(),
                Text('৳${phone.price.toStringAsFixed(0)} BDT',
                    style: const TextStyle(
            ...
            Text(phone.description,
                style: const TextStyle(
                    color: NexusTheme.textSecondary, fontSize: 13)),
            const SizedBox(height: 16),
            const Text('TECH SPECIFICATIONS',
                style: TextStyle(
                    color: NexusTheme.accentCyan,
                    fontSize: 11,
                    fontWeight: FontWeight.bold,
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('ADD FLAGSHIP PHONE TO CART',
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        ...
                        content: Text('Added ${phone.name} to cart!')),
                  );
                },
              ),
            ),
                  ...
                  errorBuilder: (ctx, err, stack) => Container(
                    ...
                    child: const Center(
                        child: Icon(Icons.phone_iphone,
                            color: NexusTheme.accentCyan, size: 40)),
                  ),
                ),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                const Icon(Icons.arrow_forward_ios,
                    color: NexusTheme.textSecondary, size: 12),
              ],
            ),
          ],
        ),
